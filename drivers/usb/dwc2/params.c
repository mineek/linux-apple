...
static void dwc2_set_apple_s5l8960x_params(struct dwc2_hsotg *hsotg)
{
	struct dwc2_core_params *p = &hsotg->params;
...
static void dwc2_set_apple_t7000_params(struct dwc2_hsotg *hsotg)
{
	struct dwc2_core_params *p = &hsotg->params;
	unsigned fifo, fifo_count;
...
const struct of_device_id dwc2_of_match_table[] = {
	...
	{ .compatible = "apple,dwc2-usb", .data = dwc2_set_apple_s5l8960x_params },
